...
-- “.к. в предыдущем файле insert-запросов не было альбомов 2019-2020 гг, 
-- а также треков к ним, то добавиим и альбомы и треки
INSERT INTO
...
-- «аполним вновь созданную таблицу св€зей между исполнител€ми и треками Trecks_Singers
INSERT INTO
...
-- «аполним вновь созданную таблицу св€зей между альбомами и треками Albums_Trecks
INSERT INTO
